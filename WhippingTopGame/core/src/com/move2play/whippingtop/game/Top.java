...
public class Top {
    ...
    public Top(int type,double velocity, double acc, double stability, double precision, double luck, double friction){
        ...
        gameOrientation=new Vector3(0,0,0);
    ...
    public void increaseYRotation(double angle){
        gameOrientation.y=(gameOrientation.y+(float)(angle*0.66f))%360f;
    }
