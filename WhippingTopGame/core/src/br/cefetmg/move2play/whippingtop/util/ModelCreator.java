...
public class ModelCreator {
    ...
    public static ModelInstance createSkyModel(Texture skyTex,float radius){
        Material skyMaterial = new Material(TextureAttribute.createDiffuse(skyTex));
        ModelBuilder modelBuilder = new ModelBuilder();
        return new ModelInstance(modelBuilder.createSphere(-radius, -radius, -radius, 20, 20, skyMaterial, VertexAttributes.Usage.Position|VertexAttributes.Usage.Normal|VertexAttributes.Usage.TextureCoordinates));
    }
